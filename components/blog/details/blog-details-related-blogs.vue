        ...
        <div class="postbox-details___related-content-wrap mb-30">
          <div class="row align-items-center">
              <div class="col-xl-7 col-lg-6">
                <h4 class="postbox-details___related-title-sm">
                  <nuxt-link href="/blog">
        ...
        <div class="row">
          <div class="col-xl-12">
              <div class="postbox-details___related-thumb mb-80">
                <img data-speed="1.1" src="/images/blog/related-post.jpg" alt="">
              </div>
          </div>
        </div>
        <div class="row">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                      <div class="porfolio-details__navigation-content text-center text-md-start">
                          <a href="#"><i class="fa-regular fa-arrow-left"></i><span>Preview</span></a>
