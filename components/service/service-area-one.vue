          ...
          <div class="col-xl-6 col-lg-5">
            ...
            >
              ...
              <div class="accordion" id="accordionExample">
                <div
                  v-for="item in accordion_data"
                  :key="item.id"
                  :class="`accordion-item tp-services-accordion-item ${item.active ? 'active' : ''}`"
                >
...
const accordion_data = [
  {
    ...
    answer:
      "I craft fast, scalable, and visually refined web experiences using modern frontend technologies.",
    lists: [
  ...
  },
  {
    ...
    tab_id: "two",
    active: true,
    question: "Product-Focused Projects",
    answer:
      "I build real-world products with a strong focus on usability and performance.",
    lists: [
  ...
  },
  {
    id: 3,
    tab_id: "three",
    question: "UI Engineering",
    answer:
      "Bringing designs to life with precision, accessibility, and attention to detail.",
    lists: [
  ...
  //   tab_id: "four",
  //   question: "Tech Stack",
  //   answer: "A modern toolkit to build efficient, maintainable, and future-ready applications.",
  //   lists: [
  //     "JavaScript, React js, Next js, Vue js, Wordpress",
  ...
  // }
  {
    ...
    question: "Tech Stack",
    answer:
      "A modern toolkit I use to build scalable, high-performance, and user-focused web applications.",
    lists: [
      "JavaScript, React.js, Next.js, Vue.js",
      "Tailwind CSS, Responsive Design",
      "REST APIs, Git & GitHub",
      "Familiar: WordPress Elementor, Node.js (Basic), Express.js (Learning)",
    ],
  },
];
